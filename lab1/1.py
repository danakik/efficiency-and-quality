...
if __name__ == "__main__":
    ...
    manager2 = UserFileManager(s3_storage)  # Singleton поверне той самий екземпляр, що manager1
    manager2.upload("file2.txt", "Дані для S3")
    print(manager2.list_files())  # Файли з S3 не будуть показані, бо Singleton вже має локальне сховище
